...
export const getAccessTokenBasedOnUser = bind(function (userId) {
  return collections.AccessTokens.findOne({ user: { id: userId } });
});
...
export const getClient = bind(function (clientId, secret) {
  ...
  return { ...clientDoc, id: clientDoc.clientId };
});
